...
export default function AnimatedBackground() {
    return (
        <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-[#fdf8f5]">
            ...
            >
                <motion.div whileHover={{ scale: 1.25, rotate: 10, y: -10 }} transition={{ type: "tween", ease: "easeOut", duration: 0.3 }}>
            ...
            >
                <motion.div whileHover={{ scale: 1.25, rotate: -15, y: -10 }} transition={{ type: "tween", ease: "easeOut", duration: 0.3 }}>
            ...
            >
                <motion.div whileHover={{ scale: 1.25, rotate: 20, y: -10 }} transition={{ type: "tween", ease: "easeOut", duration: 0.3 }}>
