...
export default function HomePage() {
    ...
    const offer = config?.specialOfferSection || {
      tag: 'Limited Time',
      headline: 'Get 20% Off Your First Custom Cake!',
      description: 'Order any of our signature cakes today and enjoy a massive discount. Perfectly baked, beautifully decorated.',
    ...
    return (
        <div className="flex flex-col bg-background min-h-screen">
            ...
            <section className="max-w-7xl mx-auto w-full px-6 py-4 lg:py-6">
                <div className="flex flex-col lg:grid lg:grid-cols-5 gap-4 lg:gap-6 h-[500px] sm:h-[600px] lg:h-[300px] xl:h-[350px]">
                    {/* Main Hero Image (Left, 3:2 width ratio -> 3/5 width) */}
                    <div className="lg:col-span-3 rounded-[2rem] overflow-hidden relative shadow-md h-[250px] sm:h-[300px] lg:h-full w-full">
                        <img 
                    ...
                    <div className="lg:col-span-2 flex flex-row lg:flex-col gap-4 lg:gap-6 h-[234px] sm:h-[276px] lg:h-full w-full">
                        <div className="flex-1 rounded-[2rem] relative overflow-hidden shadow-sm h-full w-full">
                            <img 
            ...
            <section className="bg-background py-16">
                <div className="max-w-7xl mx-auto w-full px-6">
                    <div
                        className="flex flex-col md:flex-row bg-[#eab308] rounded-[2rem] overflow-hidden shadow-lg mt-12">
                        <div className="md:w-1/3 relative bg-white hidden md:block">
                            <img src="/images/bakery_chef.png" alt="Chef"
                        ...
                        <div className="md:w-1/2 p-12 flex flex-col justify-center text-white">
                            <span
                                className="text-red-500 font-bold uppercase tracking-widest text-sm mb-4">{offer.tag}</span>
                            <h2 className="text-4xl font-extrabold mb-4 leading-tight whitespace-pre-line">
                                {offer.headline}
                            </h2>
                            ...
                            <button
                                className="bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-8 rounded-full self-start transition-colors">
                                Claim Offer
                            </button>
                        </div>
                        <div className="md:w-1/2 relative h-64 md:h-auto">
                            <img src={offer.imageUrl} alt="Special Offer"
